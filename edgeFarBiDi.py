...
##########
zone_name = "DFW"                                               # name of edge zone this script is running in
watch_zones = ["BOS", "DEN", "FarCloud"]                        # which keys this zone cares about to pull from far cloud
constr_edge = "mongodb://user:password@host:27017"              # edge mongodb connection string
constr_far = "mongodb+srv://user:password@server/myFirstDatabase?retryWrites=true&w=majority"     # far cloud connection string
